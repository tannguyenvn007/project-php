 ...
 <section id="row-breadcrumb">
	 ...
	 <nav aria-label="breadcrumb" role="navigation" class="color-nav-menu ">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Giỏ hàng</a></li>
      </ol>
    </nav> 
    </div>
	 </section>
						...
						<div class="panel panel-primary">
							<h1 class="text-center">Giỏ hàng của bạn</h1>
								...
								<div class="row">
									...
									<div class="col-md-1 col-xs-1"><b>Số lượng</b></div>
									<div class="col-md-1 col-xs-1"><b>Dung tích</b></div>
									<div class="col-md-2 col-xs-2"><b>Đơn giá(VNĐ)</b></div>
									<div class="col-md-2 col-xs-2"><b>Thành tiền (VNĐ)</b></div>
								</div>
